 ...
 */
public class TubeStatusWeekendAdapter extends RecyclerView.Adapter<TubeStatusWeekendAdapter.ViewHolder> {
    private static Context appContext;
    private static List<Tube> tubeList;
    private int cardLayout;
    private static String[] twitterHandles;

    public TubeStatusWeekendAdapter(Context appContext, List<Tube> tubeList, int cardLayout) {
    ...
    @Override
    public TubeStatusWeekendAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(cardLayout, viewGroup, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(TubeStatusWeekendAdapter.ViewHolder viewHolder, int i) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView tubeName, tubeStatus, tubeDialogName, tubeDialogStatus;
